%% Test the quaternion integration.
%% In the first case the exp map is used for the integration.
%% In the second case quaternion derivative is used and the resulting quaternion is normalized.
%% In both cases, the rotational velocity is produced by the vector part of the quaternion difference.
