...
%       - .perturbation: a structure to apply perturbations to the robot.
...
nbSPoint=size(x0,2); %number of starting points. This enables to simultaneously run several trajectories
